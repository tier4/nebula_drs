...
static const double kDegreePerSeyondAngleUnit = 180.0 / kSeyondAngleUnitPerPiRad;
static const double kSeyondAngleUnitPerDegree = kSeyondAngleUnitPerPiRad / 180.0;
