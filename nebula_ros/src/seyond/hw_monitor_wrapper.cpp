...
void SeyondHwMonitorWrapper::InitializeDiagnostics()
{
  ...
  diagnostics_updater_.add(
    "diagnostic_info", this, &SeyondHwMonitorWrapper::ParseAndAddDiagnosticInfo);
  ...
  fetch_diagnostics_timer_ = parent_node_->create_wall_timer(
    std::chrono::milliseconds(1000), std::bind(&SeyondHwMonitorWrapper::FetchDiagnosticInfo, this));
...
void SeyondHwMonitorWrapper::ParseAndAddDiagnosticInfo(
